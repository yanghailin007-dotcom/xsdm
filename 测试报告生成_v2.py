...
# 模拟第1个窗口(1-6章，实际是1-10章)
result = generator.generate_batch_report(
    start_chapter=1, 
    end_chapter=6,
    window_num=1,      # 第1个窗口
    total_windows=25   # 总共25个窗口
)

if result:
    print(f"✓ 报告生成成功!")
    print(f"  窗口编号: {result['window_num']}/25")
...
print("=" * 70)
print("\n生成的文件示例:")
print("  batch_w01_001_006_report.md        # 窗口1报告")
print("  batch_w01_001_006_data.json        # 窗口1数据")
print("  batch_w01_001_006_compliance.png   # 合规性图")
print("  batch_w01_001_006_score_trend.png  # 得分趋势图")
print("  batch_w01_001_006_emotion.png      # 情绪分布图")
print("  batch_w01_001_006_radar.png        # 雷达图")
print("\n注意: 实际使用时窗口应为10章(如1-10, 8-17等)")
