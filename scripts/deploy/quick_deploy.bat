...
REM 使用更全面的排除规则
%GIT_BASH% -c "tar -czf %ZIP_FILE% --exclude='__pycache__' --exclude='*.pyc' --exclude='.git' --exclude='logs/*' --exclude='generated_images/*' --exclude='temp_fanqie_upload/*' --exclude='.env' --exclude='test_*.py' --exclude='*.db' --exclude='小说项目/*' --exclude='debug_*' --exclude='ai_enhanced_settings/*' --exclude='Chrome/*' --exclude='knowledge_base/*' --exclude='fusion_settings/*' --exclude='*.md' --exclude='.gitignore' ."
