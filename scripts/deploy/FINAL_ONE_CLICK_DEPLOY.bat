...
echo 正在上传完整部署脚本（含Python升级）...
scp -i "%KEY_PATH%" -P 22 -o StrictHostKeyChecking=no scripts\deploy\upgrade_python_and_deploy.sh %SERVER_USER%@%SERVER_IP%:/tmp/deploy.sh
