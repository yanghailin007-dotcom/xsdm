...
"""
    ...
    ### 事件设计禁令 (以下内容在开局阶段严格禁止)
    - **禁止“日常”**: 绝对禁止任何“平静的日常”或“角色闲聊”作为开局。开局即是风暴中心。
    - **禁止“观光”**: 绝对禁止为了展示世界观而让主角进行无目的的探索或游历。
    - **禁止“练功”**: 开局阶段的实力提升必须是服务于当前核心冲突的“火线升级”，禁止出现脱离主线的闭关修炼。
    
    ### 完读率保障措施 (前三章任务清单)
    -   **第1章 (生死钩)**: 必须完成：【危机发生 -> 主角登场并被卷入危机 -> 结尾留下第一个强悬念】。
    -   **第2章 (冲突升级)**: 必须完成：【危机升级，主角处境恶化 -> 主角被迫做出第一个关键行动 -> 引入与危机相关的关键角色/信息】。
    -   **第3章 (小高潮与巨钩)**: 必须完成：【迎来第一个小高潮/情节转折 -> 给予读者一个阶段性的满足感 -> 结尾抛出巨大钩子，引爆读者的追读欲望】。
    """,
            "development_stage": """
    ## 📈 发展阶段指导（26%章节）
