...
**输出格式**：
请严格按照以下JSON结构输出，不要添加任何额外的解释或说明文字。

```json
{
    "core_style": "// 核心写作风格，一句话概括，50字以内，点明核心卖点和阅读体验。",
    "language_features": [
        "// 语言特点1：例如，多用短句、口语化表达等。",
        "// 语言特点2：例如，用词风格，是否需要感官冲击力。",
        "// 语言特点3：其他显著的语言技巧。"
    ],
    "narrative_pace": {
        "opening": "// 开篇节奏：前3-5章的核心任务和节奏要求。",
        "middle": "// 中期节奏：如何通过循环和升级保持读者的持续兴趣。",
        "late": "// 后期节奏：冲突升级后的节奏控制。"
    },
    "dialogue_style": "// 对话风格：主角、配角、反派的对话特点和功能。",
    "description_focus": [
        "// 描写重点1：最需要花笔墨描写的方面，如战斗、金手指等。",
        "// 描写重点2：次要但重要的描写点，如关键物品、人物等。",
        "// 描写重点3：需要简化的描写，避免拖慢节奏。"
    ],
    "emotional_tone": "// 情感基调：作品带给读者的核心情感体验，如热血、爽快、压抑等。",
    "chapter_structure": {
        "hook": "// 章节开头（钩子）：如何快速吸引读者进入章节。",
        "development": "// 章节发展：冲突的典型展开方式。",
        "climax_payoff": "// 章节结尾（爽点/留白）：如何制造追读的欲望。"
    },
    "important_notes": [
        "// 注意事项1：必须坚守的核心原则，如主角人设底线。",
        "// 注意事项2：需要避免的常见雷点或写作误区。",
        "// 注意事项3：其他关键成功要素。"
    ]
}
```"""
