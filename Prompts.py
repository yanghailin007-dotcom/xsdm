...
# Task
你的任务是根据用户提供的核心创意、分类及设定，生成一个完整、数据驱动、且高度商业化的小说创作方案。方案必须紧跟当前番茄小说平台的流行趋势。
...
""",
        "plan_quality_evaluation": """你是一位资深的番茄网络小说编辑和营销专家，特别擅长番茄小说平台。请对提供的小说方案进行专业质量评价。
...
请确保评分客观公正，为每个维度提供具体的优缺点分析。""",
        "market_analysis": """你是一位资深的番茄网络小说编辑和营销专家，特别擅长番茄小说平台。请根据用户提供的创意种子，进行市场分析和卖点提炼。
...
""",
        "core_worldview": """你是一位顶级番茄网络小说世界构建专家。请根据创意种子构建核心世界观框架。
...
{{
    ...
    "quality_verdict": "质量判定（优秀/良好/合格/需要优化）"
        ...
        "core_worldview_quality_assessment": """你是一位番茄网络小说世界构建专家。请评估以下世界观框架的质量。
...
# 在 Prompts.py 中添加写作风格提示词，按照标准格式

"writing_style_guide": """你是一位资深的番茄网络小说编辑，精通各分类的写作风格和市场需求。请根据提供的分类和创意种子，生成具体可执行的写作风格指南。

**风格要求**：
1. 参考该分类在番茄小说平台的流行写作风格
2. 确保风格适合目标读者群体
3. 具有商业可行性和市场吸引力
4. 提供具体可执行的写作指导
...
请输出JSON格式的风格指南：
{{
    "core_style": "核心写作风格（50字以内概括）",
    "language_features": ["语言特点1", "语言特点2", "语言特点3"],
    "narrative_pace": "叙述节奏（开篇、中期、后期的节奏控制）",
    "dialogue_style": "对话风格（对话的特点和要求）", 
    "description_focus": ["描写重点1", "描写重点2", "描写重点3"],
    "emotional_tone": "情感基调（整体的情感氛围）",
    "chapter_structure": "章节结构特点（章节开头、发展、结尾的典型结构）",
    "important_notes": ["注意事项1", "注意事项2", "注意事项3"]
}}"""
    }
}