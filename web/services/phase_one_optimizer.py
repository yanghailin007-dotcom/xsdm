...
你的任务是对作品进行平台适配性分析,从以下维度评分(0-100分):
1. 核心设定吸引力 - 世界观和核心设定是否吸引该平台读者
2. 卖点突出程度 - 作品的独特卖点是否清晰明确
3. 角色人设适配 - 主角人设是否符合平台主流偏好
4. 开篇张力 - 前3章是否有足够的吸引力
...
你需要从以下维度检查作品是否存在逻辑矛盾:
1. 世界观一致性 - 世界运行规则是否自洽
2. 角色逻辑性 - 角色行为是否符合其人设和动机
3. 势力关系合理性 - 各势力间的互动是否符合逻辑
4. 升级体系连贯性 - 力量体系是否有漏洞或矛盾
5. 剧情冲突检测 - 故事线与设定是否存在冲突
