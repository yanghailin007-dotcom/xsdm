...
### 格式规范
1. **第三人称上帝视角**：客观描述主角行动和心理，禁止第一人称
2. **短段落**：每段≤3行，多用换行，适合手机阅读
3. **对话占比≥40%**：对话推动剧情，少用旁白解释
4. **字数2000-2500字/章**：严格控制

### 内容规范
5. **情绪精准**：严格按照每章指定的情绪类型和强度写作
6. **钩子定律**：章尾必须留钩子（悬念/震惊/收获/期待）
7. **爽点设计**：每章必须有明确的爽点（装逼/收获/打脸/震惊）
8. **人设一致**：主角性格、能力值、台词风格必须前后一致
9. **承上启下**：必须承接前文，不要跳过大事件
