...
示例：主角刚完成关键交易，突然手机响起——"沈总，对方撕毁协议，联合了三家资本同时做空我们！"同伴脸色骤变："快走，董事会..."

**模板2-身份揭露型：**关键时刻→有人即将发现真相→揭露前截止
示例："等等！"同伴突然盯着主角，"你刚才签的那份合同...根本不是普通的投资协议，而是全资收购书！"主角心中一凛...

**模板3-系统提示型：**完成某事→系统提示→出乎意料的奖励/惩罚
示例：【叮！恭喜宿主消费达到新里程碑！】【奖励：返利倍数提升至20倍！】但紧接着——【警告：检测到敌对资本正在联合狙击宿主关联企业！】

**模板4-时间锁型：**倒计时开始→时间紧迫→截止
示例：【系统提示】限时任务即将到期，倒计时：23小时59分。【警告】若未能按时完成收购，竞争对手将提前锁定目标资产！

**模板5-对峙爆发型：**正面对峙→剑拔弩张→冲突爆发前一秒截止
示例：反派带着律师团堵住会议室门口："沈先生，这次你插翅难逃。"主角站起身，嘴角勾起冷笑："你确定要在这里跟我谈法律？"

**【结尾禁忌】**
- 禁止以"完"/"结束"/"休息"/"晚安"等词结尾
- 最后50字必须是悬念
- 示例中的题材元素（系统/商业/职场）应根据实际题材灵活替换，严禁将玄幻/网游/国运元素套用到非对应题材中
"""
