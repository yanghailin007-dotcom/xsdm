...
def _build_writing_prompt(settings_text: str, volume_rough_outline: str, vol_num: int) -> str:
    ...
    精简版：只传核心设定+现实规避+极简写作风格，细纲按批次动态注入。
    """
    return f"""你是番茄小说顶级签约作家，擅长写快节奏、强情绪、强反转的爽文。
...
【写作风格】
- 快节奏、强情绪、强反转，目标读者是番茄小说用户
- 手机阅读优先：段落短小，对话单独成段，叙述灵活
- 第三人称，锁定主角视角，禁止中途切换视角
- 每章开头可用1-2句话回顾上一章钩子
