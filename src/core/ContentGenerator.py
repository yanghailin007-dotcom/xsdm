...
**🔴 字数不达标后果（非常严重）：**
- ⚠️ **如果生成内容少于1500字，将被系统判定为"内容不足"，必须重新生成，浪费算力资源**
- ⚠️ **如果生成内容多于3500字，将被系统判定为"内容冗长"，必须重新生成，浪费算力资源**
- **请确保生成内容严格符合1500-3500字范围，这是硬性要求，不是建议**

**📏 强制字数分配（必须严格遵守）：**
你的输出必须严格按照以下字数分配，确保总字数达标：
- 场景1（起）：**450-600字** - 必须包含环境描写、人物状态、对话
- 场景2（承）：**500-700字** - 必须包含情节推进、冲突升级、心理描写
- 场景3（转）：**500-800字** - 必须包含高潮冲突、情感爆发、动作细节
- 场景4（合）：**300-600字** - 必须包含悬念设置、情绪收尾、钩子铺垫
- **总计：必须达到 1750-2700 字**
