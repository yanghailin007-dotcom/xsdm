...
1.  **独立黄金开局（第1-3章）**
    - 第1-3章是独立的【黄金开局弧光】，不遵循起承转合结构
    - 这是一个特殊的、独立设计的叙事单元，专注于：
      * 第1章：主角登场 + 冲突引入（钩子）
      * 第2章：冲突深化 + 金手指展现
      * 第3章：小高潮 + 破局 + 留下新钩子
...
3.  **整体目标**
    - 你设计的 {density_requirements['major_events']} 个重大事件中：
      * 第1个：黄金开局（1-3章）- 独立设计，不标记起承转合
      * 第2个起：阶段主体 - 遵循"起、承、转、合"叙事链条
"""
...
**结构层次：**
1. **黄金开局（第1-3章）** - 独立设计，不遵循起承转合
   - 章节范围: "1-3"
   - is_golden_arc: true
   - role_in_stage_arc: "黄金开局"（特殊标记，不是"起"）
   - 独立叙事单元，专注于开篇三章的连贯设计

2. **阶段主体（第4章及以后）** - 遵循起承转合
   - 从第4章开始计算
   - 第一个阶段主体事件标记为"起"
   - 后续事件按"承、转、合"推进
    ...
    "major_event_skeletons": [
        {
            "name": "黄金开局：XX危机降临",
            "is_golden_arc": true,
            "role_in_stage_arc": "黄金开局",
            "chapter_range": "1-3",
            "main_goal": "第1章：主角登场+冲突引入；第2章：冲突深化+金手指展现；第3章：小高潮+破局+留钩子。精准演绎创意种子中的开篇设计。",
            "emotional_arc": "高能开局，极速入戏",
            "description": "决定小说生死的黄金三章，必须作为完整叙事单元，100%忠于创意种子的商业化开篇设计。"
        },
        {
            "name": "阶段主体第一个事件",
            "is_golden_arc": false,
        ...
        },
        {
            ...
            "role_in_stage_arc": "承",
            "chapter_range": "16-25",
            "main_goal": "深化矛盾，主角成长，扩展世界观",
            "emotional_arc": "发展与探索",
            "description": "阶段主体的'承'部分"
        }
    ]
}

【章节范围铁律】
✅ 正确: 事件1(1-3章) + 事件2(4-15章) + 事件3(16-25章)
❌ 错误: 事件1(1-2章) + 事件2(3章) - 第1-3章必须整体
❌ 错误: 事件1(1-3章) + 事件2(3-15章) - 章节不能重叠
❌ 错误: 黄金开局标记为"起" - 它是独立设计
"""
