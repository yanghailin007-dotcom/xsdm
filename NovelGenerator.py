...
class NovelGenerator:
    ...
    def _generate_cover_prompt(self, title: str, synopsis: str, category: str) -> str:
        ...
        # 根据分类选择不同的风格
        style_templates = {
            "西方奇幻": "史诗奇幻风格，魔法光芒，巨龙，城堡，骑士，油画质感，金色边框，神秘氛围",
            "东方仙侠": "水墨风格，仙气缭绕，飞剑，仙宫，修真者，传统国风，飘逸潇洒",
            "科幻末世": "赛博朋克风格，未来城市，机械装甲，霓虹灯光，科技感，金属质感",
            "男频衍生": "热血战斗风格，主角特写，霸气侧漏，力量感，光影对比，电影质感",
            "都市高武": "现代都市与武道结合，都市夜景，武道气息，气功波动",
        ...
        # 获取对应分类的风格
        style = style_templates.get(category, "精美插画风格，小说封面设计")
